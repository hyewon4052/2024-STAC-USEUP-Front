    ...
    return (
        <View style={styles.container}>
            <ScrollView style={styles.Wrap}>
                <GoodsCarousel images={[require('../../assets/store/shirtist/shirtist.png'), require('../../assets/store/shirtist/shirtist.png')]} />
                ...
                <TabScreen
                    contents={[
                        <View>
                            <Info />
                            <Image source={require('../../assets/store/shirtist/shirtist.png')} style={styles.Images}/>
                        </View>,
                        <View>
                            <Inquiry />
                        </View>,
