    ...
    return (
        <View style={styles.container}>
            <ScrollView style={styles.Wrap}>
                <GoodsCarousel images={[require('../../assets/store/skirt/skirt.png'), require('../../assets/store/skirt/skirt.png')]} />
                ...
                <TabScreen
                    contents={[
                        <View>
                            <Info />
                            <Image source={require('../../assets/store/skirt/skirt.png')} style={styles.Images}/>
                        </View>,
                        <View>
                            <Inquiry />
                        </View>,
